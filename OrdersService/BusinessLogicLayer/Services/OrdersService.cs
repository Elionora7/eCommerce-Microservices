...
public class OrdersService : IOrdersService
{
  ...
  public OrdersService(IOrdersRepository ordersRepository, IMapper mapper, IValidator<OrderAddRequest> orderAddRequestValidator, 
                      ...
                      IValidator<OrderItemUpdateRequest> orderItemUpdateRequestValidator, UserMicroserviceClient userMicroserviceClient,ProductMicroserviceClient productMicroserviceClient)
  {
    ...
    public async Task<OrderResponse?> AddOrder(OrderAddRequest orderAddRequest)
    {
        ...
        //TO DO: add UserPersonName and Email from UsersMicroservice
        if (orderResponse != null)
        {
            if (user != null)
            {
